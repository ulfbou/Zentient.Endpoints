...
namespace Zentient.Endpoints.Builders
{
    ...
    public static class EndpointOutcomeBuilder
    {
        /// <summary>
        /// Convenience method for building an outcome with Unit as the value type.
        /// </summary>
        /// <returns>A <see cref="EndpointOutcomeBuilder{Unit}"/> instance.</returns>
        public static EndpointOutcomeBuilder<Unit> ForUnit() => new EndpointOutcomeBuilder<Unit>();
        ...
        /// </summary>
        /// <returns>A <see cref="EndpointOutcomeBuilder{Unit}"/> instance in a success state.</returns>
        public static EndpointOutcomeBuilder<Unit> IsSuccess() => ForUnit().IsSuccess(Unit.Value);
        ...
        /// <returns>A <see cref="EndpointOutcomeBuilder{TValue}"/> instance in a success state with the provided value.</returns>
        public static EndpointOutcomeBuilder<TValue> IsSuccess<TValue>(TValue value) => new EndpointOutcomeBuilder<TValue>().IsSuccess(value);

        /// <summary>
        /// Creates a new builder for a failure outcome.
        /// </summary>
        /// <returns>A <see cref="EndpointOutcomeBuilder{Unit}"/> instance in a failure state.</returns>
        public static EndpointOutcomeBuilder<Unit> IsFailure() => ForUnit().IsFailure();

        /// <summary>
        /// Creates a new builder for a failure outcome with an error.
        /// </summary>
        /// <param name="errorInfo">The error information.</param>
        /// <returns>A <see cref="EndpointOutcomeBuilder{Unit}"/> instance in a failure state with the provided error.</returns>
        public static EndpointOutcomeBuilder<Unit> WithError(ErrorInfo errorInfo) => ForUnit().WithError(errorInfo);
